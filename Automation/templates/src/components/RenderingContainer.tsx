...
function RenderingContainer(props: RenderingContainerProps) {
  ...
  switch (toRender) {
    ...
    case RENDERING_CONSTANTS['1500Image']:
      ...
      break;
    case RENDERING_CONSTANTS['4000View']:
      content = (
        <NViews
          itemsToRender={4000}
          tagName={RENDERING_CONSTANTS['4000View']}
        />
      );
      break;
    case RENDERING_CONSTANTS['4000Text']:
      content = (
        <NTexts
          itemsToRender={4000}
          tagName={RENDERING_CONSTANTS['4000Text']}
        />
      );
      break;
    case RENDERING_CONSTANTS['4000Image']:
      content = (
        <NImages
          itemsToRender={4000}
          tagName={RENDERING_CONSTANTS['4000Image']}
        />
      );
      break;
