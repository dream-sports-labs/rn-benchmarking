...
import { buildAppIOS, cleanBuild, modifyPodfile, installPods } from './helper.js';
...
async function main() {
  try {
    ...
    cleanBuild(IOS_DIR, ERROR_LOG_FILE);
    modifyPodfile(isNewArch, PODFILE_PATH);
    installPods(IOS_DIR, ERROR_LOG_FILE);
    const buildSuccess = buildAppIOS(isNewArch, BENCHMARK_DIR, ERROR_LOG_FILE, APP_PATH, APP_OUTPUT_DIR, PROJECT_NAME);
